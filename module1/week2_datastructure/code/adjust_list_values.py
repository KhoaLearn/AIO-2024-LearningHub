def adjust_list_values(data, max_value, min_value):
    """
...
max_value = 1
min_value = 0
assert adjust_list_values(data=my_list, max_value=max_value, min_value=min_value) == [1, 1, 1, 0, 1]
my_list = [10, 2, 5, 0, 1]
max_value = 2
min_value = 1
print(adjust_list_values(data=my_list, max_value=max_value, min_value=min_value))