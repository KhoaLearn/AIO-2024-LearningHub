...
data = pd.read_csv('/Users/datarist/AIO-2024-LearningHub/module2/week1_numpy/code/data/Advertising data.csv')
X = data['TV']
Y = data['Radio']
...
# Text Retrieval
file_path = '/Users/datarist/AIO-2024-LearningHub/module2/week4_statistics/code/data/Vietnamese Text Retrieval.csv'
